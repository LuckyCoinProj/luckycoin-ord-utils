...
export function createSendLKY(_a) {
    return __awaiter(this, arguments, void 0, function* ({ utxos, toAddress, toAmount, signTransaction, network, changeAddress, receiverToPayFee, feeRate, pubkey, calculateFee, enableRBF = true, }) {
        ...
        if (receiverToPayFee) {
            ...
            if (output.value < networkFee) {
                throw new Error(`Balance not enough. Need ${satoshisToAmount(networkFee)} LKY as network fee`);
            }
            ...
            if (unspent < networkFee) {
                throw new Error(`Balance not enough. Need ${satoshisToAmount(networkFee)} LKY as network fee, but only ${satoshisToAmount(unspent)} LKY.`);
            }
...
export function createMultisendOrd(_a) {
    return __awaiter(this, arguments, void 0, function* ({ utxos, toAddress, signPsbtHex, network = networks.luckycoin, changeAddress, publicKey, feeRate, }) {
